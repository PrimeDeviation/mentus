...
function initializeOnboarding() {
  ...
  introJs()
    .setOptions({
      ...
      /* Remove custom classes to use default ones */
...
function initializeDarkModeToggle() {
  ...
  toggleButton.addEventListener('click', () => {
    ...
    // Update Intro.js tooltips if onboarding is active
    const introTooltips = document.querySelectorAll('.introjs-tooltip, .introjs-tooltipReferenceLayer');
    introTooltips.forEach((tooltip) => {
      tooltip.style.backgroundColor = getComputedStyle(document.documentElement).getPropertyValue('--bg-color');
